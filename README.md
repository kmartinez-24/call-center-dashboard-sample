...
•	Speed to lead: how quickly are inbound leads being contacted after initial inquiry
•	Call quality scoring integration (if call recording/AI scoring tools are implemented)
•	No-show rate for scheduled claims strategy sessions and follow-up conversion rates
•	Individual agent scorecards with ranked performance metrics
